...
def run(arguments, content, options, state_machine, state, lineno):
    ...
    if source_rel_dir.startswith(os.pardir):
        print 'Got a parent directory of source.... uh oh.'
        raise ValueError('Cannot plot the given file (%s) as it would not be included in the build directory.' % source_file_name)
    ...
    print 'source rel dir', source_rel_dir
    dest_dir = os.path.abspath(os.path.join(setup.app.builder.outdir,
                                            source_rel_dir))

    print 'desdir: ', dest_dir
    ...
    if source_file_name == rst_file:
        ...
        print 'copy files....'
        shutil.copyfile(source_file_name, os.path.join(dest_dir, output_base + source_ext))
